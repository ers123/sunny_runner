    ...
    return (
        <div className="absolute inset-0 z-[100] flex items-center justify-center pointer-events-auto bg-white/30 backdrop-blur-md">
             <div className="w-full max-w-5xl h-full md:h-auto md:max-h-[90vh] overflow-y-auto p-4 md:p-8 flex flex-col items-center">
                 ...
                 <div className="flex items-center gap-2 bg-white px-6 py-2 rounded-full border-4 border-black mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-8">
                     {items.map(item => {
                         ...
                         return (
                             <div key={item.id} className="group relative bg-white border-4 border-black p-6 rounded-[2rem] flex flex-col items-center text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-2px] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
      ...
      return (
          <div className="absolute inset-0 w-full h-full z-[100] pointer-events-auto flex items-center justify-center p-4">
              ...
              <div className="relative w-full max-w-md flex flex-col items-center gap-6 animate-in zoom-in duration-300">
                ...
                {/* Main Card */}
                <div className="w-full bg-white border-4 border-black p-8 rounded-[2.5rem] shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center gap-6 relative overflow-hidden">
                    ...
                    <div className="flex gap-3 w-full mt-2">
                        <button
                            ...
                            className="flex-1 py-4 bg-white hover:bg-gray-50 border-2 border-black rounded-xl font-bold text-black transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none uppercase tracking-wide"
                        >
                            SHARE
                        </button>
                        <button
                            onClick={() => { audio.init(); restartGame(); }}
                            className={`flex-[2] py-4 rounded-xl font-black text-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-1px] hover:shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none transition-all text-white border-2 border-black uppercase tracking-wide
  ...
  return (
    <div className={containerClass}>
        ...
        <div className="flex justify-between items-start w-full">
            ...
            <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                    <div className="bg-white border-2 border-black rounded-2xl px-5 py-2 flex items-center gap-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                        <div className="w-3 h-3 rounded-full bg-yellow-400 border border-black animate-pulse"></div>
                        <span className="font-black text-3xl text-black tracking-tight">{score.toLocaleString()}</span>
                    </div>
                </div>

                {/* Level Progress */}
                <div className="bg-white border-2 border-black rounded-xl px-4 py-2 flex flex-col gap-1 w-48 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="flex flex-col gap-3 items-end pointer-events-auto">
                <div className="flex gap-3">
                    <div className="bg-white border-2 border-black rounded-xl px-4 py-2 flex items-center gap-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                        <Heart className="text-red-500 fill-red-500 stroke-black" size={20} />
                ...
                <div className="bg-white border-2 border-black rounded-xl p-2 hover:bg-gray-50 transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none">
                    <VolumeControl />
                </div>
            </div>
        </div>
        ...
        <div className="absolute top-24 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
            <div className="flex gap-1 sm:gap-2">
                {target.map((char, idx) => {
                    ...
                    return (
                        <div
                            key={idx}
                            className={`w-10 h-12 sm:w-12 sm:h-14 flex items-center justify-center rounded-xl border-2 font-black text-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300
                                ${isCollected
            ...
            {combo > 1 && (
                <div className="animate-bounce bg-orange-500 text-white px-6 py-1 rounded-full font-black text-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-black tracking-wider uppercase">
                    {combo}x COMBO
                </div>
            )}
        </div>
        ...
        <div className="w-full flex justify-between items-end">
            <div className="flex gap-3">
                {isImmortalityActive && (
                    <div className="bg-indigo-500 text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] animate-pulse border-2 border-black uppercase text-sm tracking-wide">
...
const StatBox = ({ label, value, icon }: { label: string, value: string, icon: string }) => (
    <div className="bg-white rounded-xl p-3 border-2 border-black flex flex-col items-center justify-center gap-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
